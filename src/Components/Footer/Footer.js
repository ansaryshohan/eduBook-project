...
const Footer = () => {
  return (
    <div className='mt-28'>
    <footer className="footer footer-center p-10 bg-accent bg-opacity-70 text-primary-content block ">
<div>
  ...
  <p className="font-bold">
    eLearning Industries Ltd. <br/>Providing reliable tech since 1992
  </p> 
